...
const closestvector = __webpack_require__(50);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (fs.existsSync(fileUri.path)) {
                const filecontent = Buffer.from(yield vscode.workspace.fs.readFile(fileUri)).toString('utf8');
        ...
        if (colors.length === 0) {
            try {
                colors = yield utils_1.getColors();
        ...
        let disposable = vscode.commands.registerCommand('color-names.generateColorNames', () => __awaiter(this, void 0, void 0, function* () {
            const text = yield vscode.env.clipboard.readText();
            try {
                const nearestColor = closest.get(utils_1.parseColor(text));
                ...
                vscode.window
                    .showErrorMessage(`The text \`${text.length > 7 ? text.slice(0, 6) + '...' : text}\` on the clipboard is not a valid color value`, 'Feedback')
                    .then((selected) => {
        ...
        vscode.commands.registerCommand('color-names.feedback', () => __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseColor = exports.getColors = void 0;
const axios_1 = __webpack_require__(3);
function getColors() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield axios_1.default.get('https://api.color.pizza/v1/');
        return res.data.colors;
    });
}
exports.getColors = getColors;
function parseColor(hexText) {
    const hexMatch = hexText.match(/^#?((?:[0-9a-f]{3}){1,2})$/i);
    if (hexMatch) {
        const str = hexMatch[1];
        let result;
        if (str.length === 3) {
            result = [str.charAt(0).repeat(2), str.charAt(1).repeat(2), str.charAt(2).repeat(2)];
        }
        else {
            result = [str.slice(0, 2), str.slice(2, 4), str.slice(4, 6)];
        }
        return result.map((hex) => parseInt(hex, 16));
    }
    throw new Error('Not valid color value!');
}
